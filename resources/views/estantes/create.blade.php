    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2 style="color: #00b4d9; text-align: center">Asignar Estante</h2>
                </div>
        ...
        <form action="{{url('estantes')}}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3 d-flex justify-content-between">
                <div>
                    ...
                    <input type="date" name="fecha_pres" class="form-control" placeholder="---">
                ...
                <div>
                    ...
                    <input type="date" name="fecha_dev" class="form-control" placeholder="---">
